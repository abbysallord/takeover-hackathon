  ...
  return (
    <div className="animate-fade-up">
      <div className="flex justify-between items-center mb-8">
        ...
        <button className="bg-[#28c840]/20 text-[#28c840] hover:bg-[#28c840]/30 px-4 py-2 rounded-lg text-sm font-medium border border-[#28c840]/30 transition-colors">
          Approve All Pending
        </button>
      </div>
      ...
      <div className="grid gap-4">
        {approvals.map((item, i) => (
          <div key={i} className="bg-white/5 border border-white/10 rounded-xl p-5 flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              {item.status === 'pending' && (
                <>
                  <button className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-[#ff5f57]/10 hover:bg-[#ff5f57]/20 text-[#ff5f57] text-xs font-medium border border-[#ff5f57]/20 transition-colors">
                    <XCircle className="w-4 h-4" /> Reject
                  </button>
                  <button className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-[#3b82f6] hover:bg-[#2563eb] text-white text-xs font-medium transition-colors">
