        ...
        <>
          ...
          <div className="fixed inset-0 flex items-center justify-center z-[101] p-4 pointer-events-none">
            <motion.div
              ...
              className="w-full max-w-md bg-[#1e1e21] border border-white/10 rounded-2xl shadow-2xl overflow-hidden pointer-events-auto"
            >
              ...
              <div className="p-6 text-white/70 text-sm max-h-[70vh] overflow-y-auto">
                {children}
              </div>
              {onConfirm && (
